  ...
  return (
    <div style={{
      ...
      <div className="glass-card" style={{ maxWidth: '580px', width: '100%', padding: '32px', position: 'relative', background: 'var(--bg-secondary)' }}>
        ...
        <div id="printable-ticket" style={{ border: '2px dashed var(--glass-border)', padding: '24px', borderRadius: '16px', background: 'var(--overlay-bg)' }}>
        ...
        {bookings.length > 1 && (
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '16px', background: 'var(--overlay-bg)', padding: '8px 16px', borderRadius: '12px' }}>
            <button
